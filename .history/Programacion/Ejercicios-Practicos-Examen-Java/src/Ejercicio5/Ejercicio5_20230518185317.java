...
public class Ejercicio5 {
    public static void main(String[] args) {
        ...
        for(Profesor profesore : centro.profesor){
            System.out.println("Nombre del profesor: " + centro.getprofesor().getNombreprofesor());
            System.out.println("Apellidos: " + centro.getProfesor().getNombreprofesors);
        };
        System.out.println("-------------------------");
        ...
        for(Alumnos alumno : centro.alumnos){
            // Nombre del alumno
            System.out.println("Nombre del alumno: " + centro.getAlumnos().getNombreAlumno());
            System.out.println("Apellidos: " + centro.getAlumnos().getApellidosAlumno());
            System.out.println("NIF: " + centro.getAlumnos().getNIFAlumno());
        }
