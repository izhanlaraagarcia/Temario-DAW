...
public class Reverso {
    ...
    public static void Reverso1() {
        ...
        // Ya tendriamos la cadena que el usuario que dar la vuelta, ahora tendremos que hacer la funcion donde recorramos cada caracter -1

        for (int indice = word.length()){
