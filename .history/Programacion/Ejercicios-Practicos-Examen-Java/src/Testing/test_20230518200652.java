...
class CentroDocente {
    ...
    public void modificarDatosProfesor(Profesor profesor, String nombre, String apellidos, String nif, String titulacion) {
    ...
    public void modificarDatosAlumno(Alumno alumno, String nombre, String apellidos, String nif, int edad) {
    ...
    public void modificarDatosCiclo(CicloFormativo ciclo, String codigo, String nombre) {
        ciclo.setCodigo(codigo);
        ciclo.setNombre(nombre);
    }

    public void mostrarDatos() {
        System.out.println("Centro Docente: " + nombre);
...
public class test {
    public static void main(String[] args) {
        ...
        while (!salir) {
            ...
            switch (opcion) {
                ...
                case 4:
                    ...
                    if (edadAlumno > 18) {
                        ...
                        System.out.println("El alumno debe ser mayor de 18 años para ser incluido en el centro.");
                    }
                    break;
                case 5:
                ...
                case 7:
                    ...
                    CicloFormativo cicloFormativo = new CicloFormativo(codigoCiclo, nombreCiclo);
                    centroDocente.agregarCiclo(cicloFormativo);
                ...
                case 8:
                    ...
                    for (CicloFormativo c : centroDocente.getClass()) {
            ...
            System.out.println(); // Espacio en blanco para separar las iteraciones del menú
        }
    }
}
